package com.micro.configserver.controller.test;
...
//@Configuration
//@ConfigurationProperties(prefix = "ss-config", ignoreUnknownFields = false)
//@PropertySource("classpath:properties/s-146-prod.properties")
//@Component
