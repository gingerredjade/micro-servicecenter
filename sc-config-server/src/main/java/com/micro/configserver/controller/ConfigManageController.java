package com.micro.configserver.controller;

import com.micro.configserver.controller.exception.ConfigException;
import com.micro.configserver.controller.bean.CFFileInfo;
import com.micro.configserver.controller.bean.CFFileKV;
...
public class ConfigManageController {
    ...
    public Boolean addConfigFile(@RequestParam(value = "key", required = true) String key){
        ...
        try {
            ...
            logger.info(ConfigException.intFilePathError+":"+ ConfigException.strFilePathError);
        }
        if(file.exists()){
            ...
            if(files != null){
                for(File childFile:files){
                    if(childFile.getName().equals(key)){
                        logger.info(ConfigException.intExistFileError+":"+ ConfigException.strExistFileError);
                        return false;
                    }
                }
            }
...
//                            bugwriter.write("5"+"\r\n");
            ...
            logger.info(ConfigException.intBuildFileError+":"+ ConfigException.strBuildFileError);
            return false;
        }
        return true;
    ...
    public Boolean removeConfigFile(@RequestParam(value = "key",required = true)String key){
        ...
        logger.info(ConfigException.intNonentityFileError+":"+ ConfigException.strNonentityFileError);
        return false;
    }
    ...
    public Boolean updateConfigInfo(CFFileInfo fileinfo) {
        ...
        if (isexistfile){
            ...
            try {
                ...
                logger.info(ConfigException.intUpdataFileError+":"+ ConfigException.strUpdataFileError);
                return false;
            }
        }else {
            logger.info(ConfigException.intUpdataFileError+":"+ ConfigException.strUpdataFileError);
