...
public class ClientControllerInRestTemplate {
	...
	public String getServerMsg() {
		 ...
		 */
		/*ServiceInstance serviceInstance = loadBalancerClient.choose("SC-SERVICE-CORE");
		...
		String response = restTemplate.getForObject("http://SC-SERVICE-CORE/msg", String.class);
		_logger.info("response={}",response);
		return response;
	}
