...
@Configuration      // 必须存在
@EnableSwagger2     // 必须存在
@ComponentScan(basePackages = {"com.micro"}) // 必须存在 扫描的API Controller package name 也可以直接扫描class (basePackageClasses)
public class SwaggerConfig extends WebMvcConfigurationSupport {

    /**
     * UI页面显示信息
     */
    private static String apiTitle = "apiTitle";
    private static String apiDesc = "apiDesc";
    private static String apiVersion = "1.0.0";
    private static String basePackage = "com.micro";
    ...
    public Docket accessToken() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Service Center APIs")   // 定义组
    ...
    private static ApiInfo apiInfo() {
        //Contact contact = new Contact("gis", "http://www.gis.com/configcenter/", "micro@126.com");
