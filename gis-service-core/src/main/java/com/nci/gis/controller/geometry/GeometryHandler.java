package com.nci.gis.controller.geometry;
...
public class GeometryHandler implements DataProcFunction<String> {
	 ...
	 * 	形如protocol://hostname[:port]/mswss/maps/services/gsgeometry/GeometrySvc/1000/length[?format=value1&points=value2&srs=value3][&auxParams=auxParamsVal]
	 *
	...
	private static String buildRequestURL(String gisServerUrl, String svcMapping, HttpServletRequest request) {
		...
		sb.append("/maps/services/gsgeometry/GeometrySvc/1000/");
