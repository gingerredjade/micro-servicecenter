...
public class TestController {
	...
	public String helloworld(
		...
		@ApiParam(name = "passPos", required = false, value = "必经点，可空，多个必经点格式如'经度1,纬度1_经度2,纬度2_经度3,纬度3'，如：116.429,40.170_116.429,39.970")
		@RequestParam(value = "passPos", defaultValue = "") String passPos,

		@ApiParam(name = "avoidPos", required = false, value = "避让点，可空，多个必经点格式如'经度1,纬度1_经度2,纬度2_经度3,纬度3'，如：116.386,40.056_116.386,39.806")
		@RequestParam(value = "avoidPos", defaultValue = "") String avoidPos,
	...
	@ApiOperation(value = "gisExecuteNavi执行导航规划", notes = "首先，设置导航起点、导航终点、必经点（多个、可空）、避让点（多个、可空），执行导航规划")
